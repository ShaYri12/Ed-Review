            ...
            <div key={course.id} className="card-body border border-2">
                ...
                <div className="card-extra d-flex mt-2 pt-2 ms-3 align-item-center justify-content-between">
                  <div className="d-flex">
                    <img className="location img-fluid mb-auto"  src="/src/assets/location.png" alt="..."/> <span className=" px-2 pe-3 coin-text ">{course.location}</span>
                  </div>
                  <div className="d-flex">
                    <img className="star img-fluid mb-auto"  src="/src/assets/star-2.png" alt="..."/> <span className="pe-2 coin-text ">{course.stars}</span>
