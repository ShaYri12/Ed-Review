      ...
      <div className="container-fluid">
        <div className="row pt-3 hero d-flex align-item-center  ">
          <div className="col-12 col-md-6 col-lg-6 hero-text  my-auto d-flex flex-column align-item-center justify-content-center">
            ...
            <div className="input-group has-search mb-3">
                ...
                <button className="btn btn-course rounded-end bg-white dropdown-toggle ps-4"  data-bs-toggle="dropdown" aria-expanded="false">Course</button>
              ...
              <div className="btn-search-box ms-3">
